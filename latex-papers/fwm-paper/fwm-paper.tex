...
As a result, most textbook treatments rely on simplifying assumptions such as undepleted pumps, single effective mode areas, negligible phase mismatch, or weak signal and idler powers.
...
\bibliographystyle{alpha}  % or plain, alpha, etc.
\bibliography{CW-FWM-Analytic-Solutions}

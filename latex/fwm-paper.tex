...
The initial conditions and physical parameter values used to generate Figure \ref{fig:case2-plot1} are provided in Appendix~\ref{app:case2-params}, Tables~\ref{tab:case2-init}--\ref{tab:case2-overlap}.

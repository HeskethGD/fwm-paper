...
\centering
\caption{Initial field amplitudes in Figure \ref{fig:case2-plot1}.}
...
\begin{minipage}[t]{0.47\textwidth}
\centering
\caption{Physical parameters in Figure \ref{fig:case2-plot1}.}
...
\centering
\captionof{table}{Mode overlap coefficients in Figure \ref{fig:case2-plot1}.}
\label{tab:case2-overlap}
\begin{tabular}{c c}
\hline
Coefficient & Value \\
\hline
